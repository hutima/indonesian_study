export const unit02 = {
  ...
  vocabulary: [
    { id: 'id-u02-voc-tulis', unitId: 'id-stage1-unit02', form: 'tulis', meaning: 'write (root)', pos: 'verb', register: 'neutral', kind: 'root', example: 'Rina menulis surat.' },
    { id: 'id-u02-voc-baca', unitId: 'id-stage1-unit02', form: 'baca', meaning: 'read (root)', pos: 'verb', register: 'neutral', kind: 'root', example: 'Rina membaca buku.' },
    { id: 'id-u02-voc-kirim', unitId: 'id-stage1-unit02', form: 'kirim', meaning: 'send (root)', pos: 'verb', register: 'neutral', kind: 'root', example: 'Ibu mengirim pesan.' },
    { id: 'id-u02-voc-selesai', unitId: 'id-stage1-unit02', form: 'selesai', meaning: 'finish; complete', pos: 'verb', register: 'neutral', kind: 'root', example: 'Rina menyelesaikan tugas.' },
    { id: 'id-u02-voc-surat', unitId: 'id-stage1-unit02', form: 'surat', meaning: 'letter', pos: 'noun', register: 'neutral', kind: 'root', example: 'Rina menulis surat.' },
    { id: 'id-u02-voc-pesan', unitId: 'id-stage1-unit02', form: 'pesan', meaning: 'message', pos: 'noun', register: 'neutral', kind: 'root', example: 'Ibu mengirim pesan.' },
    { id: 'id-u02-voc-tugas', unitId: 'id-stage1-unit02', form: 'tugas', meaning: 'task; assignment', pos: 'noun', register: 'neutral', kind: 'root', example: 'Tugas itu sudah selesai.' },
    { id: 'id-u02-voc-oleh', unitId: 'id-stage1-unit02', form: 'oleh', meaning: 'by (introduces an agent in passive clauses)', pos: 'preposition', register: 'neutral', kind: 'root', example: 'Surat itu ditulis oleh Rina.' }
  ],
  morphology: [
    {
      id: 'id-u02-morph-menulis', unitId: 'id-stage1-unit02', form: 'menulis', context: 'Rina menulis surat.', root: 'tulis', affixes: ['meN-'],
      process: 'meN- forms an active verb: the subject does the writing to an object. It surfaces as men- before tulis and the initial t is omitted.', meaning: 'write; Rina is the writer',
      steps: [
        ...
        { prompt: 'Apa fungsi meN- dalam “menulis surat”?', focus: 'semantic', choices: ['Forms an active verb: Rina writes the letter.', 'Makes the letter the writer.', 'Names the writing as a noun.'], answer: 'Forms an active verb: Rina writes the letter.', explanation: 'meN- forms an active verb with Rina as the person writing and surat as the thing written.' }
      ]
    },
    {
      ...
      steps: [
        { prompt: 'Dalam kalimat ini, apa arti “ditulis”?', focus: 'semantic', choices: ['is written', 'writes', 'writing (a piece of writing)'], answer: 'is written', explanation: 'The attached prefix di- marks a passive verb: the letter is written by Rina.' },
    ...
    },
    {
      ...
      process: 'meN- forms an active verb: the subject reads something. It surfaces as mem- before baca, with b retained.', meaning: 'read; Rina is the reader',
      steps: [
        ...
        { prompt: 'Apa fungsi meN- pada “membaca”?', focus: 'semantic', choices: ['Forms an active verb: Rina reads the book.', 'Makes the book the reader.', 'Turns baca into reading material.'], answer: 'Forms an active verb: Rina reads the book.', explanation: 'membaca describes the subject actively reading an object, whereas bacaan is reading material.' }
      ]
    },
    {
      ...
      steps: [
        { prompt: 'Dalam “Bacaan itu pendek,” apakah “bacaan” kata kerja atau kata benda?', focus: 'semantic', choices: ['Kata benda.', 'Kata kerja.', 'Kata ganti.'], answer: 'Kata benda.', explanation: '“Bacaan” names reading material; “pendek” describes it.' },
    ...
    },
    {
      ...
      process: 'meN- forms an active verb: the subject sends something. It surfaces as meng- before kirim and the initial k is omitted.', meaning: 'send; Ibu is the sender',
      steps: [
        ...
        { prompt: 'Apa fungsi meN- pada “mengirim pesan”?', focus: 'semantic', choices: ['Forms an active verb: Ibu sends the message.', 'Makes the message the sender.', 'Means the message is sent by Ibu.'], answer: 'Forms an active verb: Ibu sends the message.', explanation: 'mengirim marks the sender as subject. Compare passive forms, where the thing sent is the subject.' }
      ]
    },
    {
      ...
      steps: [
        { prompt: 'Dalam kalimat ini, apa arti “diselesaikan”?', focus: 'semantic', choices: ['is completed', 'completes', 'completion (a text)'], answer: 'is completed', explanation: 'With the task as subject and “oleh Rina” as agent, “diselesaikan” means “is completed.”' },
